...
__attribute__((__nonnull__)) _GLIBCXX20_CONSTEXPR void __fill_bvector_n(_Bit_type*, size_t,
...
struct _Bit_reference
{
  ...
  public:
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR operator bool() const _GLIBCXX_NOEXCEPT
	{
		return !!(*_M_p & _M_mask);
	}

	_GLIBCXX20_CONSTEXPR
	_Bit_reference& operator=(bool __x) _GLIBCXX_NOEXCEPT
	{
		if(__x)
			*_M_p |= _M_mask;
		else
	...
	constexpr const _Bit_reference& operator=(bool __x) const noexcept
	{
		if(__x)
			*_M_p |= _M_mask;
		else
	...
	_GLIBCXX20_CONSTEXPR
	_Bit_reference& operator=(const _Bit_reference& __x) _GLIBCXX_NOEXCEPT
	{
		return *this = bool(__x);
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR bool operator==(const _Bit_reference& __x) const
	{
	...
	#if __cplusplus >= 201103L
	_GLIBCXX20_CONSTEXPR
	friend void swap(_Bit_reference __x, _Bit_reference __y) noexcept
	{
		bool __tmp = __x;
		__x = __y;
		__y = __tmp;
	...
	_GLIBCXX20_CONSTEXPR
	friend void swap(_Bit_reference __x, bool& __y) noexcept
	{
		bool __tmp = __x;
		__x = __y;
		__y = __tmp;
	...
	_GLIBCXX20_CONSTEXPR
	friend void swap(bool& __x, _Bit_reference __y) noexcept
	{
		bool __tmp = __x;
		__x = __y;
		__y = __tmp;
...
struct _Bit_iterator_base : public std::iterator<std::random_access_iterator_tag, bool>
{
	...
	_GLIBCXX20_CONSTEXPR _GLIBCXX_ALWAYS_INLINE void _M_assume_normalized() const
	{
	}
	...
	_GLIBCXX_NODISCARD
	friend _GLIBCXX20_CONSTEXPR bool operator==(const _Bit_iterator_base& __x,
	...
	[[nodiscard]]
	friend constexpr strong_ordering operator<=>(const _Bit_iterator_base& __x,
	...
	#else
	_GLIBCXX_NODISCARD
	friend bool operator<(const _Bit_iterator_base& __x, const _Bit_iterator_base& __y)
	{
		__x._M_assume_normalized();
		__y._M_assume_normalized();
	...
	friend _GLIBCXX20_CONSTEXPR ptrdiff_t operator-(const _Bit_iterator_base& __x,
													const _Bit_iterator_base& __y)
	{
		__x._M_assume_normalized();
		__y._M_assume_normalized();
...
struct _Bit_iterator : public _Bit_iterator_base
{
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference operator*() const
	{
		_M_assume_normalized();
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference operator[](difference_type __i) const
	{
		return *(*this + __i);
	}

	_GLIBCXX_NODISCARD
	friend _GLIBCXX20_CONSTEXPR iterator operator+(const iterator& __x, difference_type __n)
	{
		iterator __tmp = __x;
		__tmp += __n;
		return __tmp;
	...
	_GLIBCXX_NODISCARD
	friend _GLIBCXX20_CONSTEXPR iterator operator+(difference_type __n, const iterator& __x)
	{
		return __x + __n;
	}
...
struct _Bit_const_iterator : public _Bit_iterator_base
{
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference operator*() const
	{
		_M_assume_normalized();
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference operator[](difference_type __i) const
	{
		return *(*this + __i);
	}

	_GLIBCXX_NODISCARD
	friend _GLIBCXX20_CONSTEXPR const_iterator operator+(const const_iterator& __x,
														 difference_type __n)
	{
	...
	_GLIBCXX_NODISCARD
	friend _GLIBCXX20_CONSTEXPR const_iterator operator+(difference_type __n,
...
{
	typedef typename __gnu_cxx::__alloc_traits<_Alloc>::template rebind<_Bit_type>::other
		_Bit_alloc_type;
	...
	struct _Bvector_impl_data
	{
		...
		struct
		{
			...
			_GLIBCXX20_CONSTEXPR
			void operator=(_Bit_iterator __it)
			{
				_M_p = __it._M_p;
			}
		} _M_start;
		...
		_GLIBCXX20_CONSTEXPR
		void _M_swap_data(_Bvector_impl_data& __x) _GLIBCXX_NOEXCEPT
		{
	...
	struct _Bvector_impl : public _Bit_alloc_type, public _Bvector_impl_data
	{
		_GLIBCXX20_CONSTEXPR
		_Bvector_impl()
			_GLIBCXX_NOEXCEPT_IF(is_nothrow_default_constructible<_Bit_alloc_type>::value)
  ...
  public:
	...
	_GLIBCXX20_CONSTEXPR
	_Bit_alloc_type& _M_get_Bit_allocator() _GLIBCXX_NOEXCEPT
	{
		return this->_M_impl;
	}

	_GLIBCXX20_CONSTEXPR
	const _Bit_alloc_type& _M_get_Bit_allocator() const _GLIBCXX_NOEXCEPT
	{
		return this->_M_impl;
	}
	...
	_GLIBCXX20_CONSTEXPR
	_Bvector_base(const allocator_type& __a) : _M_impl(_Bit_alloc_type(__a))
	{
	}
...
class vector<bool, _Alloc> : protected _Bvector_base<_Alloc>
{
  ...
  private:
	_GLIBCXX20_CONSTEXPR
	vector(vector&& __x, const allocator_type& __a, true_type) noexcept : _Base(std::move(__x), __a)
	{
	}

	_GLIBCXX20_CONSTEXPR
	vector(vector&& __x, const allocator_type& __a, false_type) : _Base(__a)
	{
  ...
  public:
	_GLIBCXX20_CONSTEXPR
	vector(vector&& __x, const __type_identity_t<allocator_type>& __a) noexcept(
		_Bit_alloc_traits::_S_always_equal()) :
		vector(std::move(__x), __a, typename _Bit_alloc_traits::is_always_equal{})
	{
	}

	_GLIBCXX20_CONSTEXPR
	vector(const vector& __x, const __type_identity_t<allocator_type>& __a) : _Base(__a)
	{
		_M_initialize(__x.size());
		_M_copy_aligned(__x.begin(), __x.end(), begin());
	}
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_iterator begin() const _GLIBCXX_NOEXCEPT
	{
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_iterator end() const _GLIBCXX_NOEXCEPT
	{
		return this->_M_impl._M_finish;
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reverse_iterator rbegin() _GLIBCXX_NOEXCEPT
	{
		return reverse_iterator(end());
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reverse_iterator rbegin() const _GLIBCXX_NOEXCEPT
	{
		return const_reverse_iterator(end());
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reverse_iterator rend() _GLIBCXX_NOEXCEPT
	{
		return reverse_iterator(begin());
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reverse_iterator rend() const _GLIBCXX_NOEXCEPT
	{
		return const_reverse_iterator(begin());
	}

	#if __cplusplus >= 201103L
	[[__nodiscard__]] _GLIBCXX20_CONSTEXPR const_iterator cbegin() const noexcept
	{
		return const_iterator(this->_M_impl._M_start._M_p, 0);
	}

	[[__nodiscard__]] _GLIBCXX20_CONSTEXPR const_iterator cend() const noexcept
	{
		return this->_M_impl._M_finish;
	}

	[[__nodiscard__]] _GLIBCXX20_CONSTEXPR const_reverse_iterator crbegin() const noexcept
	{
		return const_reverse_iterator(end());
	}

	[[__nodiscard__]] _GLIBCXX20_CONSTEXPR const_reverse_iterator crend() const noexcept
	{
		return const_reverse_iterator(begin());
	}
	#endif

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type size() const _GLIBCXX_NOEXCEPT
	{
		return size_type(end() - begin());
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type max_size() const _GLIBCXX_NOEXCEPT
	{
		const size_type __isize =
			__gnu_cxx::__numeric_traits<difference_type>::__max - int(_S_word_bit) + 1;
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR size_type capacity() const _GLIBCXX_NOEXCEPT
	{
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference operator[](size_type __n) const
	{
		__glibcxx_requires_subscript(__n);
		return begin()[__n];
	}
  ...
  public:
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR reference at(size_type __n)
	{
		_M_range_check(__n);
		return (*this)[__n];
	}

	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference at(size_type __n) const
	{
		_M_range_check(__n);
		return (*this)[__n];
	}
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference front() const
	{
		__glibcxx_requires_nonempty();
		return *begin();
	}
	...
	_GLIBCXX_NODISCARD _GLIBCXX20_CONSTEXPR const_reference back() const
	{
		__glibcxx_requires_nonempty();
		return *(end() - 1);
	}
	...
	_GLIBCXX20_CONSTEXPR
	static void swap(reference __x, reference __y) _GLIBCXX_NOEXCEPT
	{
		bool __tmp = __x;
		__x = __y;
		__y = __tmp;
	...
	#if __cplusplus >= 201103L
	template<typename _InputIterator, typename = std::_RequireInputIter<_InputIterator>>
	_GLIBCXX20_CONSTEXPR iterator insert(const_iterator __position, _InputIterator __first,
	...
	template<typename... _Args>
	_GLIBCXX20_CONSTEXPR iterator emplace(const_iterator __pos, _Args&&... __args)
	{
  ...
  protected:
	...
	_GLIBCXX20_CONSTEXPR
	void _M_initialize_value(bool __x) _GLIBCXX_NOEXCEPT
	{
	...
	template<typename _InputIterator>
	_GLIBCXX20_CONSTEXPR void _M_initialize_range(_InputIterator __first, _InputIterator __last,
	...
	_GLIBCXX20_CONSTEXPR void _M_initialize_range(_ForwardIterator __first, _ForwardIterator __last,
	...
	template<typename _InputIterator>
	_GLIBCXX20_CONSTEXPR void _M_assign_aux(_InputIterator __first, _InputIterator __last,
											std::input_iterator_tag)
	{
	...
	template<typename _ForwardIterator>
	_GLIBCXX20_CONSTEXPR void _M_assign_aux(_ForwardIterator __first, _ForwardIterator __last,
											std::forward_iterator_tag)
	{
	...
	template<typename _InputIterator>
	_GLIBCXX20_CONSTEXPR void _M_insert_range(iterator __pos, _InputIterator __first,
	...
	template<typename _ForwardIterator>
	_GLIBCXX20_CONSTEXPR void _M_insert_range(iterator __position, _ForwardIterator __first,
...
// Fill a partial word.
_GLIBCXX20_CONSTEXPR
inline void __fill_bvector(_Bit_type* __v, unsigned int __first, unsigned int __last,
...
__attribute__((__nonnull__)) _GLIBCXX20_CONSTEXPR inline void
...
_GLIBCXX20_CONSTEXPR
inline void __fill_a1(_GLIBCXX_STD_C::_Bit_iterator __first, _GLIBCXX_STD_C::_Bit_iterator __last,
					  const bool& __x)
{
