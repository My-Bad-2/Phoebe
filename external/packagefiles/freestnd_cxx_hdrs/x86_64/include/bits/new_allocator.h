// for freestnd_cxx_hdrs compatibility

#ifndef BITS_NEW_ALLOCATOR_H
#define BITS_NEW_ALLOCATOR_H
...
class __new_allocator
{
  public:
	...
	__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR __new_allocator() _GLIBCXX_USE_NOEXCEPT
	{
	}

	__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR __new_allocator(const __new_allocator&)
...
#undef _GLIBCXX_OPERATOR_NEW
	...
	__attribute__((__always_inline__)) void destroy(pointer __p)
	{
		__p->~_Tp();
	}
	#endif
