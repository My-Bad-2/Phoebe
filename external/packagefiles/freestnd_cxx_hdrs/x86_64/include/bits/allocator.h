...
class allocator<void>
{
  public:
	...
	__attribute__((__always_inline__)) constexpr allocator(const allocator<_Up>&) noexcept
	{
	}
...
class allocator : public __allocator_base<_Tp>
{
  public:
	...
	__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR allocator(const allocator& __a)
		_GLIBCXX_NOTHROW : __allocator_base<_Tp>(__a)
	{
	}
	...
	template<typename _Tp1>
	__attribute__((__always_inline__)) _GLIBCXX20_CONSTEXPR allocator(const allocator<_Tp1>&)
		_GLIBCXX_NOTHROW
	{
	}
...
__attribute__((__always_inline__)) inline _GLIBCXX20_CONSTEXPR bool
	operator==(const allocator<_T1>&, const allocator<_T2>&) _GLIBCXX_NOTHROW
{
	return true;
}
